                        ...
                        <div class="row">
                            <div class="mt-5 col-xl-12 col-md-12 col-sm-12 col-12 row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="w-100 form-control user-search br-30" id="UserTableSearch" placeholder="Search Here...">
                                </div>
                                <div class="col-md-4">
                                    <div class="btn-group  mb-2 me-4" user="group">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="btndefault6" style="">
                                            ...
                                            <a href="#" class="dropdown-item" id="addUserButton"><i class="flaticon-gear-fill mr-1"></i>
                                                @component('svg_icons.add') @slot('width') 24 @endslot @slot('height') 24 @endslot @slot('fill') #000 @endslot @endcomponent

                                                Add New User</a>
                                            <a href="#" class="dropdown-item" id="viewUserButton"><i class="flaticon-bell-fill-2 mr-1"></i>
